...
aws --region ${tpl_aws_region} s3 cp s3://$${S3_BUCKET}/$${CONSUL_ZIP} /tmp/$${CONSUL_ZIP}
...
{
  "datacenter": "repl-testing",
  "data_dir": "/opt/consul/data",
  "client_addr": "0.0.0.0",
  "log_level": "INFO",
  "ui": true,
  "retry_join": ["provider=aws tag_key=ConsulDC tag_value=replication-testing"]
}
EOF
